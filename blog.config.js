...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '5af4d8cc01924d378c43db84dfceac4d',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.ijava.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, Geepair, blog', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '赣ICP备2023016390号', // 备案号 闽ICP备XXXXXX
